...
const FooterBar = () => {
  ...
  const customFooter = useMemo(
    () => (
      <footer className='relative h-auto py-16 px-6 md:px-24 w-full flex flex-col items-center justify-between overflow-hidden' style={{ background: '#0f172a' }}>
        <div className='absolute hidden md:block top-[204px] left-[-100px] w-[151px] h-[151px] rounded-full' style={{ background: 'rgba(139, 92, 246, 0.2)' }}></div>
        <div className='absolute md:hidden bottom-[20px] left-[-50px] w-[80px] h-[80px] rounded-full' style={{ background: 'rgba(139, 92, 246, 0.2)', opacity: 0.6 }}></div>
